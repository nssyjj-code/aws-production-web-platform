...
This document describes the authentication and authorization approach used by the AWS Production Web Platform.
...
The AWS Production Web Platform uses AWS-native authentication and authorization mechanisms that emphasize credential separation, least privilege, and operational security.
